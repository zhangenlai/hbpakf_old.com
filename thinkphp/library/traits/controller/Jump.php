...
trait Jump
{
     ...
     * @return void
     */
    protected function success($msg = '', $url = null, $data = '_parent_reload', $wait = 2, array $header = [])
    {
     ...
     * @return void
     */
    protected function error($msg = '', $url = null, $data = '_parent_reload', $wait = 4, array $header = [])
    {
        $type = $this->getResponseType();
        if (is_null($url)) {
